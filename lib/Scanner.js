...
class Scanner {
    ...
    scan() {
        try {
            ...
            if (e instanceof ScannError) {
                require('./index').scannError(e);
                return null;
            } else {
                throw e;
            }
    ...
    string() {
        ...
        if (this.isAtEnd()) {
            this.raiseScannError('Unterminated string.')
        }
        ...
        switch(c) {
            ...
            default: {
                if (this.isDigit(c)) {
                    ...
                    this.raiseScannError('unexpected character.');
                }
                break;
            }
        }
    }
    raiseScannError(message) {
        const error = new ScannError(
            this.line,
            this.source,
            this.current,
            message
